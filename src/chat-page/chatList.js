        ...
        return (
            <div className="container-chat-list">
                    ...
                    >
                        <List
                            ...
                            renderItem={item => (
                                <List.Item
                                    key={item.id}
                                    onClick={() => this.props.handleSelectedChat(item.groupid, item.groupname)}
                                >
                                    <List.Item.Meta
                                        avatar={
                ...
                <Modal
                    ...
                    onOk={() =>
                        this.handleOkCreateGroup(this.state.uid, this.state.username, this.state.createdgroupName)
                    }
                    confirmLoading={this.state.confirmLoadingCreateGroup}
                    onCancel={this.handleCancelCreateGroup}
                >
                    <Input placeholder="Enter Group Name" onChange={this.onChangeCreateGroup} />
                </Modal>
                ...
                >
                    <Input placeholder="Enter Group ID" onChange={this.onChangeJoinGroup} />
                </Modal>
            </div>
        );
    }
